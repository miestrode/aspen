...
pub fn midgame_score(piece: Piece, square: Square) -> i32 {
    midgame_value(piece.role) + midgame_table(piece.role)[table_index(piece.color, square)]
}

pub fn endgame_score(piece: Piece, square: Square) -> i32 {
    endgame_value(piece.role) + endgame_table(piece.role)[table_index(piece.color, square)]
}

pub fn game_phase(role: Role) -> i32 {
    match role {
...
fn table_index(color: Color, square: Square) -> usize {
    color.fold_wb(square.flip_vertical(), square).to_usize()
}

fn midgame_value(role: Role) -> i32 {
    match role {
        Role::Pawn => 82,
        Role::Knight => 337,
        Role::Bishop => 365,
...
fn endgame_value(role: Role) -> i32 {
    match role {
        Role::Pawn => 94,
        Role::Knight => 281,
        Role::Bishop => 297,
...
fn midgame_table(role: Role) -> &'static [i32; 64] {
    match role {
        Role::Pawn => &MIDGAME_PAWN,
        Role::Knight => &MIDGAME_KNIGHT,
        Role::Bishop => &MIDGAME_BISHOP,
        Role::Rook => &MIDGAME_ROOK,
        Role::Queen => &MIDGAME_QUEEN,
        Role::King => &MIDGAME_KING,
    }
}

fn endgame_table(role: Role) -> &'static [i32; 64] {
    match role {
        Role::Pawn => &ENDGAME_PAWN,
        Role::Knight => &ENDGAME_KNIGHT,
        Role::Bishop => &ENDGAME_BISHOP,
        Role::Rook => &ENDGAME_ROOK,
        Role::Queen => &ENDGAME_QUEEN,
        Role::King => &ENDGAME_KING,
    }
}
